...
console.log(barMan1);
console.log(barMan2);
var tragos1 = new Tragos("Mojito", "verde", 150);
var tragos2 = new Tragos("nombreTragos", "azul", 80);
tragos1.setNombre("Mojito");
console.log(tragos1.getNombre());
tragos1.setColor("Amarillo");
console.log(tragos1.getColor());
//tragos1.setCantidad("Amarillo");
tragos1.setCantidad(156);
console.log(tragos1.getCantidad());
console.log(tragos1);
console.log(tragos2);
